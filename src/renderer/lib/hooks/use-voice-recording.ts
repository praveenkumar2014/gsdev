...
export function useVoiceRecording(): UseVoiceRecordingReturn {
  ...
  const startRecording = useCallback(async (language?: string) => {
    ...
    try {
      ...
      // Request microphone access with language if specified
      ...
      // Add language constraint if browser supports it
      if (language && typeof (navigator.mediaDevices as any).getUserMedia === 'function') {
        (constraints as any).audio = {
          ...constraints.audio,
          language: language,
        }
      }
