...
2. Create the file .gsdev/worktree.json with setup commands
...
Example output for .gsdev/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .gsdev/worktree.json with the appropriate setup commands.`,
}
