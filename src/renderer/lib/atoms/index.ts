...
// Voice language selection atom for speech recognition
export const voiceLanguageAtom = atomWithStorage<string>(
  "agents:voiceLanguage",
  "en-US", // Default to English
)

// Supported voice languages with their ISO 639-1 codes
...
// Nano API key
export const nanoApiKeyAtom = atomWithStorage<string>(
  "agents:nano-api-key",
  "",
  undefined,
  { getOnInit: true },
...
// Banana API key
export const bananaApiKeyAtom = atomWithStorage<string>(
  "agents:banana-api-key",
  "",
  undefined,
  { getOnInit: true },
)
...
// OpenCode API key
export const opencodeApiKeyAtom = atomWithStorage<string>(
  "agents:opencode-api-key",
  "",
  undefined,
  { getOnInit: true },
)
...
export const dalleApiKeyAtom = atomWithStorage<string>(
  "agents:dalle-api-key",
  "",
  undefined,
  { getOnInit: true },
)
...
export const midjourneyApiKeyAtom = atomWithStorage<string>(
  "agents:midjourney-api-key",
  "",
  undefined,
  { getOnInit: true },
)
...
export const stableDiffusionApiKeyAtom = atomWithStorage<string>(
  "agents:stable-diffusion-api-key",
  "",
  undefined,
  { getOnInit: true },
)
...
export const browserAutomationConfigAtom = atomWithStorage<{
  headless: boolean
  defaultProvider: 'playwright' | 'selenium'
  timeout: number
  retryAttempts: number
}>("agents:browser-automation-config", {
  headless: true,
...
export const systemLightThemeIdAtom = atomWithStorage<string>(
  ...
  "gsdev-light", // Default light theme
  undefined,
  { getOnInit: true },
)
...
export const apiKeyOnboardingCompletedAtom = atomWithStorage<boolean>(
  "agents:apiKeyOnboardingCompleted",
  false, // Require API key setup on first run
  undefined,
  { getOnInit: true },
)
