...
export const chatsRouter = router({
  ...
  list: publicProcedure
    ...
    .query(({ input }) => {
      ...
      // Add mock chat for demo if no chats exist
      if (chatList.length === 0) {
        return [{
          id: "demo-chat-1",
          projectId: "demo-project-1",
          title: "Demo Chat",
          summary: "This is a demo chat for testing",
          archivedAt: null,
          createdAt: new Date(),
          updatedAt: new Date(),
        }]
    ...
    .mutation(async ({ input }) => {
      ...
      if (!hasInternet) {
        ...
        try {
          ...
          const apiUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://gsdev.dev"
