...
export const SeleniumToolMeta: ToolMeta = {
  icon: GlobeIcon,
  title: (part) => {
    const isPending =
    ...
    if (isPending) return "Running Selenium"
...
export function AgentSeleniumTool({ part, projectPath }: { part: any; projectPath?: string }) {
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="font-medium">Selenium: {action}</span>
      </div>
