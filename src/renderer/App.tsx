...
// Landing page wrapper (outside TRPCProvider since it doesn't need tRPC)
function LandingPageWrapper() {
  const showLandingPage = useAtomValue(showLandingPageAtom)
  const setShowLandingPage = useSetAtom(showLandingPageAtom)

  if (showLandingPage) {
    return <LandingPage />
  }

  // If not showing landing page, render the main app with TRPC
  return <AppContent />
}
...
export function App() {
  ...
  // Landing page outside TRPCProvider since it doesn't need tRPC
  if (showLandingPage) {
    return (
      <WindowProvider>
