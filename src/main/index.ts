...
export function getBaseUrl(): string {
  ...
  return import.meta.env.MAIN_VITE_API_URL || "https://gsdev.dev"
}

export function getAppUrl(): string {
  return process.env.ELECTRON_RENDERER_URL || "https://gsdev.dev/agents"
}
...
const server = createServer((req, res) => {
  ...
  // Serve local auth page for development
...
<body>
  <div class="container">
    ...
    <p class="note">Local Development Mode</p>
  </div>
  <script>
    function authenticate(provider) {
      // For local dev, redirect to main app with provider info
...
if (gotTheLock) {
  ...
  app.whenReady().then(async () => {
    ...
    app.setAboutPanelOptions({
      ...
      copyright: "Copyright © 2026 GSDEV",
    })
          ...
          submenu: [
            {
              ...
              click: async () => {
                ...
                await shell.openExternal("https://gsdev.dev")
              },
            },
          ],
        },
