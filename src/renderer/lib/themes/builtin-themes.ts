...
/**
 * gsdev Dark - Default dark theme matching the app's original design
 * Uses the brand orange (#FF6600) as primary/accent color
 */
const TWENTYFIRST_DARK: VSCodeFullTheme = {
  ...
  colors: {
    ...
    "focusBorder": "#ff6600", // primary orange
    "textLink.foreground": "#ff6600",
    "textLink.activeForeground": "#ff8533",
    ...
    "button.background": "#ff6600", // primary orange
...
/**
 * gsdev Light - Default light theme matching the app's original design
 * Uses the brand orange (#FF6600) as primary/accent color
 */
const TWENTYFIRST_LIGHT: VSCodeFullTheme = {
  ...
  colors: {
    ...
    "focusBorder": "#ff6600", // primary orange
    "textLink.foreground": "#ff6600",
    "textLink.activeForeground": "#cc5200",
 ...
 */
export const DEFAULT_LIGHT_THEME_ID = "gsdev-light"
export const DEFAULT_DARK_THEME_ID = "gsdev-dark"
