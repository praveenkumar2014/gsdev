 ...
 * Supports legacy (~/.gsdev/worktrees/{projectId}/{chatId}/) and
 * new format (~/.gsdev/worktrees/{projectName}/{worktreeFolder}/).
 *
...
export function resolveProjectPathFromWorktree(
  ...
  const worktreeMarker = path.join(".gsdev", "worktrees")
  ...
  try {
    ...
    // Path format: /Users/.../.gsdev/worktrees/{projectSlug}/{worktreeFolder}
    const worktreeBase = path.join(os.homedir(), ".gsdev", "worktrees")
