...
export const billingMethodAtom = atomWithStorage<string>(
  "agents:billingMethod",
  "api-key", // Default to api-key to support all model providers (local, Claude, OpenRouter, OpenAI)
)
